...
class Product
{
    ...
    public function get_type_module() {
        return $this->data[PimFileHelper::rev_normalize_field(substr(__FUNCTION__, 4))];
    }

    public function set_type_module($value) {
        $this->data[PimFileHelper::rev_normalize_field(substr(__FUNCTION__, 4))] = $value;
    }
    ...
    public function get_format_cycle() {
        return $this->data[PimFileHelper::rev_normalize_field(substr(__FUNCTION__, 4))];
    }

    public function set_format_cycle($value) {
        $this->data[PimFileHelper::rev_normalize_field(substr(__FUNCTION__, 4))] = $value;
    }
    ...
    public function get_diplomante() {
        return $this->data[PimFileHelper::rev_normalize_field(substr(__FUNCTION__, 4))];
    }

    public function set_diplomante($value) {
        $this->data[PimFileHelper::rev_normalize_field(substr(__FUNCTION__, 4))] = $value;
    }
    ...
    public function set_groups($value) {
        $this->data[PimFileHelper::rev_normalize_field(substr(__FUNCTION__, 4))] = $value;
    }

    public function get_option__groups() {
        return $this->data[PimFileHelper::rev_normalize_field(substr(__FUNCTION__, 4))];
    }

    public function set_option__groups($value) {
        $this->data[PimFileHelper::rev_normalize_field(substr(__FUNCTION__, 4))] = $value;
    }

    public function get_option__products() {
        return $this->data[PimFileHelper::rev_normalize_field(substr(__FUNCTION__, 4))];
    }

    public function set_option__products($value) {
        $this->data[PimFileHelper::rev_normalize_field(substr(__FUNCTION__, 4))] = $value;
    }

    public function get_journee_complementaire__groups() {
        return $this->data[PimFileHelper::rev_normalize_field(substr(__FUNCTION__, 4))];
    }

    public function set_journee_complementaire__groups($value) {
        $this->data[PimFileHelper::rev_normalize_field(substr(__FUNCTION__, 4))] = $value;
    }

    public function get_journee_complementaire__products() {
        return $this->data[PimFileHelper::rev_normalize_field(substr(__FUNCTION__, 4))];
    }

    public function set_journee_complementaire__products($value) {
        $this->data[PimFileHelper::rev_normalize_field(substr(__FUNCTION__, 4))] = $value;
    }

    public function get_session__groups() {
        return $this->data[PimFileHelper::rev_normalize_field(substr(__FUNCTION__, 4))];
    }

    public function set_session__groups($value) {
        $this->data[PimFileHelper::rev_normalize_field(substr(__FUNCTION__, 4))] = $value;
    }

    public function get_session__products() {
        return $this->data[PimFileHelper::rev_normalize_field(substr(__FUNCTION__, 4))];
    }

    public function set_session__products($value) {
        $this->data[PimFileHelper::rev_normalize_field(substr(__FUNCTION__, 4))] = $value;
    }
